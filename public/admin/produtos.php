...
<head>
    ...
    <style>
        ...
        .upload-area:hover {
            border-color: #5e219c;
            background-color: rgba(94, 33, 156, 0.05);
        }
...
<body>
        ...
        <div class="main-content">
            ...
            <main class="scrollable-content">
                ...
                <div class="d-flex justify-content-between align-items-end mb-4">
                    ...
                    <button class="btn btn-primario-kao px-4 py-2" data-bs-toggle="modal"
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="d-flex align-items-center gap-3">
                                                <img src="../<?php echo $produtos['imagem']; ?>"
                                                    alt="Camiseta Personalizada Básica" class="rounded"
                                                    style="width: 48px; height: 48px; object-fit: cover;">
                                                <span class="text-dark fw-medium"><?php echo $produtos['nome']; ?></span>
                                            </div>
                                        </td>
                                        <td class="text-muted"><?php echo $produtos['categoria']; ?></td>
                                        <td class="text-dark fw-semibold">R$ <?php echo $produtos['preco']; ?></td>
                                        <td>
                                            <span
                                                class="badge bg-success bg-opacity-10 text-success border-0 rounded px-2 py-1">
                                                <?php echo $produtos['estoque']; ?>
                                            </span>
                                        </td>
                                        <td class="text-end px-4">
                                            <button type="button" class="btn btn-sm btn-light text-primary me-1 btn-editar"
                                                data-bs-toggle="modal" data-bs-target="#modalEditarProduto"
                                                data-id="<?php echo $produtos['id']; ?>"
                                                data-nome="<?php echo $produtos['nome']; ?>"
                                                data-descricao="<?php echo $produtos['descricao']; ?>"
                                                data-categoria="<?php echo $produtos['categoria']; ?>"
                                                data-preco="<?php echo $produtos['preco']; ?>"
                                                data-imagem="<?php echo $produtos['imagem']; ?>">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <a href="../../backend/functions/produtos/excluirProduto.php?id=<?php echo $produtos['id']; ?>"
    ...
    <div class="modal fade" id="modalNovoProduto" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                ...
                <form action="../../backend/functions/produtos/criarProduto.php" method="POST"
                    enctype="multipart/form-data" id="formNovoProduto">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="nome"
                                    placeholder="Ex: Camiseta Personalizada Básica"
                                    requiredaria-label="Nome do Produto">
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-medium text-dark">Imagem do Produto</label>
                                <div class="mb-3">
                                    <img id="previewImagemNovo" src="" alt="Imagem do produto"
                                        style="display: none; margin: 0 auto 1rem auto; max-width: 350px; height: auto; border-radius: 8px;">
                                </div>
                                <div class="upload-area" role="button" aria-label="Área de upload de imagem">
                                    <i class="bi bi-cloud-arrow-up fs-2 text-muted"></i>
                                    <p class="mb-1 mt-2 text-dark fw-medium">Arraste e solte a imagem aqui ou clique
                                        para selecionar</p>
                                    <p class="text-muted small mb-0">PNG, JPG até 5MB</p>
                                    <input type="file" name="imagem" class="d-none" id="fileUpload"
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" name="descricao" rows="3"
                                    placeholder="Descreva o produto..." aria-label="Descrição do Produto"
                                    required></textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="preco" placeholder="0,00"
                                    aria-label="Valor do Produto" required>
                            </div>
    ...
    <div class="modal fade" id="modalEditarProduto" tabindex="-1" aria-labelledby="modalEditarLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow">

                <div class="modal-header border-bottom-0 pb-0 pt-4 px-4">
                    <h5 class="modal-title fw-bold" id="modalEditarLabel">Editar Produto</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                </div>

                <form action="../../backend/functions/produtos/editarProduto.php" method="POST"
                    enctype="multipart/form-data" id="formEditarProduto">
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <label class="form-label fw-medium text-dark">Nome do Produto</label>
                                <input type="text" class="form-control" name="nome" id="produtoNome"
                                    placeholder="Ex: Camiseta Personalizada Básica" required>
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-medium text-dark">Imagem do Produto</label>
                                <div class="mb-3">
                                    <img id="previewImagemAtual" src="" alt="Imagem atual"
                                        style="display: block; margin: 0 auto 1rem auto; max-width: 350px; height: auto; border-radius: 8px;">
                                </div>
                                <div class="upload-area upload-area-editar" role="button"
                                    aria-label="Área de upload de imagem">
                                    <i class="bi bi-cloud-arrow-up fs-2 text-muted"></i>
                                    <p class="mb-1 mt-2 text-dark fw-medium">Arraste e solte a imagem aqui ou clique
                                        para selecionar</p>
                                    <p class="text-muted small mb-0">PNG, JPG até 5MB</p>
                                    <input type="file" name="imagem" class="d-none" id="fileUploadEditar"
                                        aria-label="Selecionar arquivo de imagem">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <label class="form-label fw-medium text-dark">Descrição</label>
                                <textarea class="form-control" name="descricao" id="produtoDescricao" rows="3"
                                    placeholder="Descreva o produto..." required></textarea>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-medium text-dark">Categoria</label>
                                <select class="form-select" name="categoria" id="produtoCategoria" required>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-medium text-dark">Valor (R$)</label>
                                <input type="text" class="form-control" name="preco" id="produtoPreco"
                    ...
                    <div class="modal-footer border-top-0 pt-0 pb-4 px-4">
                        <button type="button" class="btn btn-light px-4" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" class="btn btn-primario-kao px-4">Salvar Alterações</button>
                    </div>
                </form>
    ...
    <script>
        // Upload area para novo produto
        document.querySelector('.upload-area').addEventListener('click', function () {
            document.getElementById('fileUpload').click();
        });

        // Upload area para editar produto
        document.querySelector('.upload-area-editar').addEventListener('click', function () {
            document.getElementById('fileUploadEditar').click();
        });

        // Quando o modal de edição é aberto, preenche os campos
        document.getElementById('modalEditarProduto').addEventListener('show.bs.modal', function (event) {
            ...
            document.getElementById('previewImagemAtual').src = '../' + imagem;
        });

        // Preview da imagem no novo produto
        document.getElementById('fileUpload').addEventListener('change', function (event) {
            const file = event.target.files[0];
            if (file) {
                const reader = new FileReader();
                reader.onload = function (e) {
                    const preview = document.getElementById('previewImagemNovo');
        ...
        // Preview da imagem no editar produto
        document.getElementById('fileUploadEditar').addEventListener('change', function (event) {
            const file = event.target.files[0];
            if (file) {
                const reader = new FileReader();
                reader.onload = function (e) {
                    document.getElementById('previewImagemAtual').src = e.target.result;
                };
                reader.readAsDataURL(file);
            }
        });
