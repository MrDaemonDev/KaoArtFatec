        ...
        <div class="main-content">
            ...
            <div class="scrollable-content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button class="btn"
                        style="background-color: #5E219C; color: white; border: none; height: fit-content;"
                        data-bs-toggle="modal" data-bs-target="#novoEstoque">
                        ...
                        <table class="table align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <button class="btn btn-sm btn-outline"
                                            style="background-color: #5f219c; color: white; border: none;"
                                            data-bs-toggle="collapse" data-bs-target="#tamanhos-camisa">
                                            <i class="bi bi-plus"></i>
                                        </button>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="https://imageswscdn.wslojas.com.br/files/27020/camiseta-algodao-unisex-personalizacao-silk-screen-307224.jpg"
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-primary bg-opacity-10 text-primary border-0 rounded-pill px-3 py-2">Aguardando
                                            encomenda</span>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm"
                                            style="color: #0d6efd; background: none; border: none;" title="Editar">
                                            <i class="bi bi-pencil"></i>
                                        </button>
                                        <button class="btn btn-sm"
                                            style="color: #dc3545; background: none; border: none;" title="Deletar">
                                ...
                                <tr class="collapse" id="tamanhos-camisa">
                                    <td colspan="6">
                                        <div class="p-3 bg-light rounded">
                                            <h6 class="mb-3 text-center" style="color: #6A31AA;">Tamanhos Disponíveis
                                            </h6>
                                                    ...
                                                    <div class="card p-2 text-center">
                                                        ...
                                                        <div class="btn-group w-100" role="group">
                                                            <button type="button" class="btn btn-sm"
                                                                style="background-color: #5E219C; color: white;">+</button>
                                                            <button type="button" class="btn btn-sm"
                                                                style="background-color: #5E219C; color: white;">-</button>
                                                        </div>
                                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="https://images.unsplash.com/photo-1650959858546-d09833d5317b"
                                                width="40" class="rounded">
                                            <div>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-success bg-opacity-10 text-success border-0 rounded-pill px-3 py-2">Em
                                            estoque</span>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="https://files.expanssiva.com.br/products/256x256/cartao-de-visita-supremo.jpg"
                                                width="40" class="rounded">
                                            <div>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-warning bg-opacity-10 text-warning border-0 rounded-pill px-3 py-2">Acabando</span>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm"
                                            style="color: #0d6efd; background: none; border: none;" title="Editar">
                                ...
                                <tr>
                                    <td>
                                        <button class="btn btn-sm btn-outline"
                                            style="background-color: #5f219c; color: white; border: none;"
                                            data-bs-toggle="collapse" data-bs-target="#tamanhos-mascara">
                                            <i class="bi bi-plus"></i>
                                        </button>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUdPU5xo02kKJtMlFlV9ej5x1bGgkSDrz8Iw&s"
                                                width="40" class="rounded">
                                            <div>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-danger bg-opacity-10 text-danger border-0 rounded-pill px-3 py-2">Quase
                                            acabando</span>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn"
                                    style="background-color: #b892ff; color: white; font-weight: bold; border: none;">Salvar</button>
                            </div>
                        </div>
                    </div>
                </div>
