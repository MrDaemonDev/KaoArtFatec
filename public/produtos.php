...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top shadow">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.php"><img src="img/etc/passaroKao.png" alt="logotipo KaoArt"
                    id="passaro" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
                ...
                <form class="d-flex me-3" role="search">
                    <input id="buscarProduto" class="form-control form-control-sm" type="search"
                        placeholder="Buscar produtos..." aria-label="Search">
                    <button class="btn btn-outline-light btn-sm ms-2" type="submit"><i
                        ...
                        <div class="d-flex align-items-center gap-3 ms-3 border-start ps-4">
                            ...
                            <div class="dropdown ms-1">
                                <button class="d-flex align-items-center text-white border-0 bg-transparent p-0"
                                    type="button" data-bs-toggle="dropdown" aria-expanded="false" style="outline: none;">
                                    <div class="rounded-circle text-white d-flex align-items-center justify-content-center fw-bold shadow-sm"
                                        style="width: 32px; height: 32px; background-color: #5e219c; font-size: 0.85rem;">
                                        AD
                                    </div>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2">
                                    <li>
                                        <a class="dropdown-item py-2 text-dark"
                                            href="<?php echo isset($baseURL) ? $baseURL : '../public'; ?>/configuracao.php">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-danger py-2"
                                            href="<?php echo isset($baseURL) ? $baseURL : '../public'; ?>/../backend/auth/logout.php">
    ...
    <section class="pt-4 pb-5 mt-3">
        <div class="container">
            <div class="mb-4 text-center">
                ...
                <button class="btn btn-outline-secondary filtro btn-sm m-1" data-filter="camisetas">Apenas
                    Blusas</button>
                <button class="btn btn-outline-secondary filtro btn-sm m-1" data-filter="Canecas">Apenas
                    Canecas</button>
                <button class="btn btn-outline-secondary filtro btn-sm m-1" data-filter="cartao">Apenas Cartões</button>
                <button class="btn btn-outline-secondary filtro btn-sm m-1" data-filter="mascaras">Apenas
                    Máscaras</button>
            </div>
                    ...
                    <div class="col-md-3 col-sm-6 produto" data-category="<?php echo $produtos['categoria']; ?>"
                        ...
                        <div class="card h-100 shadow-sm border border-2 rounded">
                            ...
                            <div class="card-body text-center d-flex flex-column">
                                ...
                                <p class="card-text text-muted small flex-grow-1"><?php echo $produtos['descricao']; ?></p>
                                <p class="fw-bold text-roxo mb-3 preco">
                                    R$ <?php echo number_format($produtos['preco'], 2, ',', '.'); ?>
                                    <?php if ($produtos['unidade']): ?>
                                        <span class="small text-muted fw-normal">- <?php echo $produtos['unidade']; ?></span>
                                    <?php endif; ?>
                                </p>
                                <a href="carrinho.php" class="btn btn-primary btn-sm w-100 add-to-cart mt-auto">Adicionar ao
                                    Carrinho</a>
                            </div>
                        </div>
                    </div>
